...
// export function useMathDrag(props: CoreRenderProps) {
...
//   return {
//     draggable: props.cellId !== "readonly" && props.node.type !== "root-wrapper",
...
//       nodes.push(  //TODO here make draggable? 
...
//   const drag = useMathDrag(baseProps); //React Hook "useMathDrag" is called in function "renderTextNode" that is neither a React function component nor a custom React Hook function. React component names must start with an uppercase letter. React Hook names must start with the word "use".eslintreact-hooks/rules-of-hooks
...
//       )}
//       style={getInlineStyle(baseProps.inheritedStyle)}
//       onClick={(e) => { //TODO redundant?? Idk maybe not
//         e.stopPropagation();
...
//       )}
//       style={getInlineStyle(baseProps.inheritedStyle)}
//       onClick={(e) => { //TODO do I even need this?
//         e.stopPropagation();
//         if (node.base.children.length === 0) {
//           baseProps.onCursorChange({ containerId: node.base.id, index: 0 });
//           // defer focus so React has applied the cursor change
