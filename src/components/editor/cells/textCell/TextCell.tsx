...
// const TextCell: React.FC<BaseCellProps<TextCellContent>> = ({
//   content,
//   onChange,
// }) => {
...
const TextCell: React.FC<BaseCellProps<TextCellContent> & { displayNumber?: string }> = ({
  content,
  onChange,
  displayNumber,
}) => {
